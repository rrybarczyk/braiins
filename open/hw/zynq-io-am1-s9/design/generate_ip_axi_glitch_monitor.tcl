...
# Generate IP core
####################################################################################################
set ip_name "axi_glitch_monitor"
set ip_library "ip"
set ip_version "1.0"
...
set ip_hdl_files [ list \
    "glitch_detector.vhd" \
    "glitch_monitor_S_AXI.vhd" \
    "axi_glitch_monitor_v1_0.vhd" \
]
...
set_property display_name "Glitch Monitor" [ipx::current_core]
set_property description "Glitch Monitor IP core" [ipx::current_core]
...
set_property value 7 [ipx::get_user_parameters C_S_AXI_ADDR_WIDTH -of_objects [ipx::current_core]]
set_property value 7 [ipx::get_hdl_parameters C_S_AXI_ADDR_WIDTH -of_objects [ipx::current_core]]
...
# Custom parameters
####################################################################################################
# Custom parameter - number of channels
if {$board == "S9"} {
    set c_channels 5
} else {
    set c_channels 6
...
puts "INFO: Number of channels: $c_channels"

set_property value $c_channels [ipx::get_user_parameters C_CHANNELS -of_objects [ipx::current_core]]
set_property value $c_channels [ipx::get_hdl_parameters C_CHANNELS -of_objects [ipx::current_core]]
